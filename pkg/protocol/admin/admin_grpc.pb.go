...
const (
	...
	Admin_SetPlatformOperator_FullMethodName      = "/openim.admin.admin/SetPlatformOperator"
	Admin_FindPlatformOperator_FullMethodName     = "/openim.admin.admin/FindPlatformOperator"
...
type AdminClient interface {
	...
	SetPlatformOperator(ctx context.Context, in *SetPlatformOperatorReq, opts ...grpc.CallOption) (*SetPlatformOperatorResp, error)
	FindPlatformOperator(ctx context.Context, in *FindPlatformOperatorReq, opts ...grpc.CallOption) (*FindPlatformOperatorResp, error)
...
func (c *adminClient) SetPlatformOperator(ctx context.Context, in *SetPlatformOperatorReq, opts ...grpc.CallOption) (*SetPlatformOperatorResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetPlatformOperatorResp)
	err := c.cc.Invoke(ctx, Admin_SetPlatformOperator_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminClient) FindPlatformOperator(ctx context.Context, in *FindPlatformOperatorReq, opts ...grpc.CallOption) (*FindPlatformOperatorResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindPlatformOperatorResp)
	err := c.cc.Invoke(ctx, Admin_FindPlatformOperator_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServer interface {
	...
	SetPlatformOperator(context.Context, *SetPlatformOperatorReq) (*SetPlatformOperatorResp, error)
	FindPlatformOperator(context.Context, *FindPlatformOperatorReq) (*FindPlatformOperatorResp, error)
...
func (UnimplementedAdminServer) SetPlatformOperator(context.Context, *SetPlatformOperatorReq) (*SetPlatformOperatorResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetPlatformOperator not implemented")
}
func (UnimplementedAdminServer) FindPlatformOperator(context.Context, *FindPlatformOperatorReq) (*FindPlatformOperatorResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindPlatformOperator not implemented")
}
...
func _Admin_SetPlatformOperator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetPlatformOperatorReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).SetPlatformOperator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Admin_SetPlatformOperator_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).SetPlatformOperator(ctx, req.(*SetPlatformOperatorReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Admin_FindPlatformOperator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindPlatformOperatorReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServer).FindPlatformOperator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Admin_FindPlatformOperator_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServer).FindPlatformOperator(ctx, req.(*FindPlatformOperatorReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Admin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetPlatformOperator",
			Handler:    _Admin_SetPlatformOperator_Handler,
		},
		{
			MethodName: "FindPlatformOperator",
			Handler:    _Admin_FindPlatformOperator_Handler,
		},
		{
